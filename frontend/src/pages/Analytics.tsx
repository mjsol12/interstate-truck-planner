            ...
            <>
              <Grid container spacing={2} sx={{ mb: 3 }}>
                ...
                <Grid size={{ xs: 6, sm: 4, md: 2 }}>
                  <MetricCard
                    label="Avg trip time"
                    value={String(overview.avg_duration_hrs)}
                    unit="hrs"
              ...
              <Grid container spacing={2} sx={{ mb: 3 }}>
                <Grid size={{ xs: 12, lg: 8 }}>
                  <Panel
                    title="Trip volume"
                    description="Planned trips over the last 14 days"
                  >
                ...
                <Grid size={{ xs: 12, lg: 4 }}>
                  <Panel
                    ...
                    description="Completed, pending, and failed trips"
                  >
                    <StatusBreakdownChart
                      data={data.trips_by_status}
                      total={overview.total_trips}
                    />
                  </Panel>
                </Grid>
              </Grid>
              ...
              <Grid container spacing={2} sx={{ mb: 3 }}>
                <Grid size={{ xs: 12, md: 4 }}>
                  <Panel
                    title="Planned stops"
                    description="Aggregate fuel, rest, and break stops"
                  >
                ...
                <Grid size={{ xs: 12, md: 8 }}>
                  <Panel
                    title="HOS & cycle insights"
                    description="70-hour / 8-day property-carrying rule"
                  >
              ...
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, lg: 7 }}>
                  <Panel
                    title="Recent trips"
                    description="Latest planned routes"
                    flush
                  >
                    <TableSurface
                      plain
