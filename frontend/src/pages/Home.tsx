...
const quickLinks: QuickLink[] = [
  {
    title: 'Analytics',
    description: 'Trip analytics, fleet metrics, HOS insights, and recent activity.',
    to: '/analytics',
    cta: 'View analytics',
  ...
  {
    title: 'Planner',
    description: 'Calculate routes, fuel stops, and rest breaks from your cycle hours.',
    to: '/planner',
    cta: 'Open planner',
...
const steps = [
  {
    step: '1',
    title: 'Plan a trip',
    description: 'Enter current location, pickup, dropoff, and hours already on your cycle.',
  },
  {
    step: '2',
    title: 'Review the route',
    description: 'See mapped stops, fuel breaks, and HOS-compliant rest periods.',
  },
  {
    step: '3',
    title: 'Export log sheets',
    description: 'Open daily FMCSA grids with duty segments filled from the timeline.',
  },
]
        ...
        <>
          <Grid container spacing={2} sx={{ mb: 3 }}>
            {hasTripData ? (
              <>
                <Grid size={{ xs: 6, sm: 3 }}>
                  <StatCard label="Total trips" value={String(overview!.total_trips)} />
                </Grid>
                <Grid size={{ xs: 6, sm: 3 }}>
                  <StatCard label="Total miles" value={String(overview!.total_miles)} unit="mi" />
                </Grid>
                <Grid size={{ xs: 6, sm: 3 }}>
                  <StatCard label="Log sheets" value={String(overview!.total_log_sheets)} />
                </Grid>
                <Grid size={{ xs: 6, sm: 3 }}>
                  <StatCard label="Success rate" value={String(overview!.success_rate)} unit="%" />
                </Grid>
              </>
            ) : (
